...
const MusicCard = ({ data }) => {
  return (
    <article className="flex justify-around sm:justify-center flex-wrap shrink-0 gap-x-2 gap-y-6 sm:gap-8 text-gray-300">
      {data?.map((item) => {
        const {
          id,
          name,
        ...
        return (
          <div key={id} className="w-44 mt-1 relative text-gray-300">
            <div>
