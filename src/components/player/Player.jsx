...
const Player = () => {
  ...
  return (
    <section className="fixed bottom-0 h-20 bg-gray-800 w-[100vw] max-w-[1440px] rounded-t-lg  z-20">
      <audio
      ...
      <div
        ...
        className="w-[99.6%] progress border-t-[5px] border-green-500 relative mx-auto"
      >
        <div
          style={{ width: `${progressBarWidth}%` }}
          className="relative -top-1 border-t-[5px] border-t-green-500"
        >
          <span
            className="absolute -top-2.5 -right-3 w-4 h-4 hover:scale-110 rounded-full bg-green-400 "
            onMouseUp={() => setMouseDown(false)}
          ></span>
        </div>
      </div>
      <div className="flex justify-between px-4 items-center h-20 pb-5 text-gray-300">
        <SongDetails
          name={name}
